...
/*!*************************************************!*\
  !*** ./resources/assets/js/announceFilepond.js ***!
  \*************************************************/
FilePond.registerPlugin(FilePondPluginFileEncode, FilePondPluginImagePreview, FilePondPluginFilePoster); // ANNOUNCE IMAGES

if (announces_images !== 'undefined') {
  if (announces_images.length > 0) {
    FilePond.create(document.querySelector('input[id="announce_image1"]'), {
  ...
  if (announces_images.length > 1) {
    FilePond.create(document.querySelector('input[id="announce_image2"]'), {
      labelIdle: "Arrastra & suelta tu imagen o <span class=\"filepond--label-action\">B\xFAscala</span>",
      imagePreviewHeight: '120px',
      files: [{
        source: '12345',
  ...
  if (announces_images.length > 2) {
    FilePond.create(document.querySelector('input[id="announce_image3"]'), {
      labelIdle: "Arrastra & suelta tu imagen o <span class=\"filepond--label-action\">B\xFAscala</span>",
      imagePreviewHeight: '120px',
      files: [{
        source: '12345',
  ...
  if (announces_images.length > 3) {
    FilePond.create(document.querySelector('input[id="announce_image4"]'), {
      labelIdle: "Arrastra & suelta tu imagen o <span class=\"filepond--label-action\">B\xFAscala</span>",
      imagePreviewHeight: '120px',
      files: [{
        source: '12345',
