<div class="row">
    <div class="form-group col-12 col-md-6">
        ...
        <select wire:model="selectedCommunity" class="form-control" name="community" id="community" required>
    ...
    @if(!is_null($selectedCommunity))
        <div class="form-group col-12 col-md-6">
            ...
            <select wire:model="selectedProvince" class="form-control" name="province" id="province" required>
