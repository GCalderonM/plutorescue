...
@section('content')
    <div class="bg-gray-200 text-black h-full">
        <h1 class="text-xl md:text-4xl font-bold underline text-center pt-4">{{ __('Conoce el equipo...') }}</h1>
        ...
        <div class="flex flex-wrap p-3 justify-center">
            <h1 class="text-xl md:text-4xl font-bold underline text-center pt-4">{{ __('¿Que es PlutoRescue?') }}</h1>
        </div>
        <div class="flex flex-wrap text-center pt-3">
            <p class="text-lg md:text-2xl px-5 lg:px-40 font-bold">
        ...
        <div class="flex flex-wrap text-center pt-3">
            <p class="text-md md:text-xl px-5 lg:px-40 font-bold">
